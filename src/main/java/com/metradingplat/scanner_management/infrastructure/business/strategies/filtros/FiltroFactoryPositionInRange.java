...
public class FiltroFactoryPositionInRange implements IFiltroFactory {
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                parametros.add(this.crearParametroTimeframe(
                                (ValorString) valoresSeleccionados.get(EnumParametro.TIMEFRAME_POSITION_IN_RANGE)));
        ...
        private Parametro crearParametroTimeframe(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.TIMEFRAME_POSITION_IN_RANGE,
                                EnumParametro.TIMEFRAME_POSITION_IN_RANGE.getEtiqueta(), valor, opciones);
        }
        ...
        public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                this.objValidador.validarStringConOpciones(this.enumFiltro, EnumParametro.TIMEFRAME_POSITION_IN_RANGE,
                                valoresSeleccionados.get(EnumParametro.TIMEFRAME_POSITION_IN_RANGE),
