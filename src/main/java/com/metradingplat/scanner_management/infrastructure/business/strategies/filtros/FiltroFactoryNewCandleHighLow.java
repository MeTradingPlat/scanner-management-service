...
public class FiltroFactoryNewCandleHighLow implements IFiltroFactory {
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                parametros.add(this.crearParametroOpcionExtremo(
                                (ValorString) valoresSeleccionados.get(EnumParametro.OPCION_EXTREMO_NEW_CANDLE)));
                parametros.add(this
        ...
        private Parametro crearParametroTimeframe(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.TIMEFRAME_NEW_CANDLE,
                                EnumParametro.TIMEFRAME_NEW_CANDLE.getEtiqueta(),
                                valor, opciones);
        }

        private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
                // compute_value() solo devuelve 0.0 (no hizo nuevo maximo/minimo) o
                // 1.0 (si) -- IGUAL_A 1 es la unica condicion que tiene sentido.
                ...
                return new Parametro(EnumParametro.CONDICION, "parameter.newCandleHighLow.condicion", valor, opciones);
        }
