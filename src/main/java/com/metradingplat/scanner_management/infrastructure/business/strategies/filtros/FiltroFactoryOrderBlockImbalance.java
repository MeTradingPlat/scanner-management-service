...
public class FiltroFactoryOrderBlockImbalance implements IFiltroFactory {
        private final EnumFiltro enumFiltro = EnumFiltro.ORDER_BLOCK_IMBALANCE;
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                parametros.add(this.crearParametroTimeframe(
                                (ValorString) valoresSeleccionados.get(EnumParametro.TIMEFRAME_ORDER_BLOCK_IMBALANCE)));
                parametros.add(this.crearParametroLookbackVelas(
                                (ValorInteger) valoresSeleccionados.get(EnumParametro.LOOKBACK_VELAS_ORDER_BLOCK_IMBALANCE)));
                parametros.add(this.crearParametroDireccion(
                                (ValorString) valoresSeleccionados.get(EnumParametro.DIRECCION_ORDER_BLOCK_IMBALANCE)));
                // compute_value() en signal-processing-service devuelve 0.0/1.0 --
                // IGUAL_A 1 es la unica condicion que tiene sentido, mismo criterio
                // que BREAK_OVER_RECENT_HIGHS_LOWS.
        ...
        private Parametro crearParametroTimeframe(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.TIMEFRAME_ORDER_BLOCK_IMBALANCE,
                                EnumParametro.TIMEFRAME_ORDER_BLOCK_IMBALANCE.getEtiqueta(), valor, opciones);
        }
        ...
        private Parametro crearParametroLookbackVelas(ValorInteger valorUsuario) {
                ...
                return new Parametro(EnumParametro.LOOKBACK_VELAS_ORDER_BLOCK_IMBALANCE,
                                EnumParametro.LOOKBACK_VELAS_ORDER_BLOCK_IMBALANCE.getEtiqueta(), valor, opciones);
        }
        ...
        private Parametro crearParametroDireccion(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.DIRECCION_ORDER_BLOCK_IMBALANCE,
                                EnumParametro.DIRECCION_ORDER_BLOCK_IMBALANCE.getEtiqueta(), valor, opciones);
        }
        ...
        private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
                ...
                return new Parametro(EnumParametro.CONDICION, "parameter.orderBlockImbalance.condicion", valor, opciones);
        }
        ...
        public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                this.objValidador.validarStringConOpciones(this.enumFiltro,
                                EnumParametro.TIMEFRAME_ORDER_BLOCK_IMBALANCE,
                                valoresSeleccionados.get(EnumParametro.TIMEFRAME_ORDER_BLOCK_IMBALANCE),
                                TIMEFRAMES_SOPORTADOS)
                                .ifPresent(errores::add);

                this.objValidador.validarInteger(this.enumFiltro, EnumParametro.LOOKBACK_VELAS_ORDER_BLOCK_IMBALANCE,
                                valoresSeleccionados.get(EnumParametro.LOOKBACK_VELAS_ORDER_BLOCK_IMBALANCE), 5, 100)
                                .ifPresent(errores::add);

                this.objValidador.validarString(this.enumFiltro, EnumParametro.DIRECCION_ORDER_BLOCK_IMBALANCE,
                                valoresSeleccionados.get(EnumParametro.DIRECCION_ORDER_BLOCK_IMBALANCE),
