...
public class FiltroFactoryHighLowOfDay implements IFiltroFactory {
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                // simbolo con velas de hoy -- compute_value devuelve un % 0-100
                // continuo (que tan cerca del extremo elegido), el usuario
                // necesita un umbral real para que el filtro filtre algo.
        ...
        private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
                ...
                ValorCondicional valor = new ValorCondicional(
                                ...
                                valorUsuario != null ? valorUsuario.getValor2() : 100F);
        ...
        public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                this.objValidador.validarStringConOpciones(this.enumFiltro, EnumParametro.TIMEFRAME_HIGH_LOW_DAY,
                                valoresSeleccionados.get(EnumParametro.TIMEFRAME_HIGH_LOW_DAY), TIMEFRAMES_SOPORTADOS)
                                .ifPresent(errores::add);
