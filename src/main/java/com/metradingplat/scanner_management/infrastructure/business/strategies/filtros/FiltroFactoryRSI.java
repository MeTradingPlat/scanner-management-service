...
public class FiltroFactoryRSI implements IFiltroFactory {
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                parametros
                                .add(this.crearParametroPeriodoRsi(
                                                (ValorInteger) valoresSeleccionados.get(EnumParametro.PERIODO_RSI)));
                parametros
                                .add(this.crearParametroTimeframe(
                                                (ValorString) valoresSeleccionados.get(EnumParametro.TIMEFRAME_RSI)));
        ...
        private Parametro crearParametroPeriodoRsi(ValorInteger valorUsuario) {
                ...
                return new Parametro(EnumParametro.PERIODO_RSI, EnumParametro.PERIODO_RSI.getEtiqueta(), valor,
                                opciones);
        }
        ...
        private Parametro crearParametroTimeframe(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.TIMEFRAME_RSI, EnumParametro.TIMEFRAME_RSI.getEtiqueta(), valor,
                                opciones);
        }
        ...
        public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                this.objValidador
                                .validarCondicional(this.enumFiltro, EnumParametro.CONDICION,
                                                valoresSeleccionados.get(EnumParametro.CONDICION), 0.0F, 100.0F)
                                .ifPresent(errores::add);

                this.objValidador
                                .validarInteger(this.enumFiltro, EnumParametro.PERIODO_RSI,
