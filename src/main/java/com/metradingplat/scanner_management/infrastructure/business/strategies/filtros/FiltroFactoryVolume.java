...
import com.metradingplat.scanner_management.domain.enums.valores.EnumTipoVolumen;
...
public class FiltroFactoryVolume implements IFiltroFactory {
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                parametros.add(
                                this.crearParametroTimeframe((ValorString) valoresSeleccionados
                                                .get(EnumParametro.TIMEFRAME_VOLUME)));
        ...
        private Parametro crearParametroTipoVolumen(ValorString valorUsuario) {
                ...
                EnumTipoVolumen enumValor = valorUsuario != null ? EnumTipoVolumen.valueOf(valorUsuario.getValor())
                                : EnumTipoVolumen.CIERRE;
        ...
        private Parametro crearParametroTimeframe(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.TIMEFRAME_VOLUME, EnumParametro.TIMEFRAME_VOLUME.getEtiqueta(),
                                valor,
                                opciones);
        }
