...
public class FiltroFactoryPercentageRange implements IFiltroFactory {
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                parametros.add(this.crearParametroTimeframe(
                                (ValorString) valoresSeleccionados
                                                .get(EnumParametro.TIMEFRAME_PERCENTAGE_RANGE_PERCENT)));
        ...
        private Parametro crearParametroTimeframe(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.TIMEFRAME_PERCENTAGE_RANGE_PERCENT,
                                EnumParametro.TIMEFRAME_PERCENTAGE_RANGE_PERCENT.getEtiqueta(), valor, opciones);
        }
        ...
        public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                this.objValidador
                                .validarCondicional(this.enumFiltro, EnumParametro.CONDICION,
                                                valoresSeleccionados.get(EnumParametro.CONDICION), 0.1F, 500.0F)
                                .ifPresent(errores::add);

                this.objValidador.validarStringConOpciones(this.enumFiltro, EnumParametro.TIMEFRAME_PERCENTAGE_RANGE_PERCENT,
                                valoresSeleccionados.get(EnumParametro.TIMEFRAME_PERCENTAGE_RANGE_PERCENT),
