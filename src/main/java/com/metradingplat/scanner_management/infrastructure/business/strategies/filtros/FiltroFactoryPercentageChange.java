...
public class FiltroFactoryPercentageChange implements IFiltroFactory {
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                parametros.add(this.crearParametroTimeframe(
                                (ValorString) valoresSeleccionados
                                                .get(EnumParametro.TIMEFRAME_PERCENTAGE_CHANGE_PERCENT)));
        ...
        private Parametro crearParametroTimeframe(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.TIMEFRAME_PERCENTAGE_CHANGE_PERCENT,
                                EnumParametro.TIMEFRAME_PERCENTAGE_CHANGE_PERCENT.getEtiqueta(), valor, opciones);
        }
