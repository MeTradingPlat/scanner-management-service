...
public class FiltroFactoryBreakOverRecentHighsLows implements IFiltroFactory {
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                parametros.add(this.crearParametroOpcionExtremo(
                                (ValorString) valoresSeleccionados.get(EnumParametro.OPCION_EXTREMO_BREAK_OVER)));
                parametros.add(this
        ...
        private Parametro crearParametroTimeframe(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.TIMEFRAME_BREAK_OVER,
                                EnumParametro.TIMEFRAME_BREAK_OVER.getEtiqueta(),
                                valor, opciones);
        }
        ...
        private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
                ...
                return new Parametro(EnumParametro.CONDICION, "parameter.breakOverRecentHighsLows.condicion", valor, opciones);
        }
        ...
        public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                this.objValidador.validarStringConOpciones(this.enumFiltro, EnumParametro.TIMEFRAME_BREAK_OVER,
                                valoresSeleccionados.get(EnumParametro.TIMEFRAME_BREAK_OVER), TIMEFRAMES_SOPORTADOS)
                                .ifPresent(errores::add);
