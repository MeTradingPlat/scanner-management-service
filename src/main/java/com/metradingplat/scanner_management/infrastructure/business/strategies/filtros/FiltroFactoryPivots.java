...
public class FiltroFactoryPivots implements IFiltroFactory {
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                parametros.add(
                                this.crearParametroTimeframe((ValorString) valoresSeleccionados
                                                .get(EnumParametro.TIMEFRAME_PIVOTS)));
        ...
        private Parametro crearParametroTimeframe(ValorString valorUsuario) {
                ...
                List<Valor> opciones = this
                                .obtenerOpciones(new EnumTimeframe[] { EnumTimeframe._1D, EnumTimeframe._1W,
                                                EnumTimeframe._1MO });
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.TIMEFRAME_PIVOTS, EnumParametro.TIMEFRAME_PIVOTS.getEtiqueta(),
                                valor,
                                opciones);
        }
