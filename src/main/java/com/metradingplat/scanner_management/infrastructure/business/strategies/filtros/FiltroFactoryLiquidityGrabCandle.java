...
public class FiltroFactoryLiquidityGrabCandle implements IFiltroFactory {
        private final EnumFiltro enumFiltro = EnumFiltro.LIQUIDITY_GRAB_CANDLE;
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                parametros.add(this.crearParametroTimeframe(
                                (ValorString) valoresSeleccionados.get(EnumParametro.TIMEFRAME_LIQUIDITY_GRAB_CANDLE)));
                parametros.add(this.crearParametroLookbackVelas(
                                (ValorInteger) valoresSeleccionados.get(EnumParametro.LOOKBACK_VELAS_LIQUIDITY_GRAB_CANDLE)));
                parametros.add(this.crearParametroProporcionMechaCuerpo(
                                (ValorFloat) valoresSeleccionados.get(EnumParametro.PROPORCION_MECHA_CUERPO_LIQUIDITY_GRAB_CANDLE)));
                parametros.add(this.crearParametroDireccion(
                                (ValorString) valoresSeleccionados.get(EnumParametro.DIRECCION_LIQUIDITY_GRAB_CANDLE)));
        ...
        private Parametro crearParametroTimeframe(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.TIMEFRAME_LIQUIDITY_GRAB_CANDLE,
                                EnumParametro.TIMEFRAME_LIQUIDITY_GRAB_CANDLE.getEtiqueta(), valor, opciones);
        }
        ...
        private Parametro crearParametroLookbackVelas(ValorInteger valorUsuario) {
                ...
                return new Parametro(EnumParametro.LOOKBACK_VELAS_LIQUIDITY_GRAB_CANDLE,
                                EnumParametro.LOOKBACK_VELAS_LIQUIDITY_GRAB_CANDLE.getEtiqueta(), valor, opciones);
        }

        private Parametro crearParametroProporcionMechaCuerpo(ValorFloat valorUsuario) {
                EnumTipoValor enumTipoValor = EnumTipoValor.FLOAT;
                List<Valor> opciones = this.obtenerOpciones(new IEnumValores[0]);
                ValorFloat valor = new ValorFloat(
                                "etiqueta.vacia",
                                enumTipoValor,
                                valorUsuario != null ? valorUsuario.getValor() : 2.0F);
                return new Parametro(EnumParametro.PROPORCION_MECHA_CUERPO_LIQUIDITY_GRAB_CANDLE,
                                EnumParametro.PROPORCION_MECHA_CUERPO_LIQUIDITY_GRAB_CANDLE.getEtiqueta(), valor, opciones);
        }
        ...
        private Parametro crearParametroDireccion(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.DIRECCION_LIQUIDITY_GRAB_CANDLE,
                                EnumParametro.DIRECCION_LIQUIDITY_GRAB_CANDLE.getEtiqueta(), valor, opciones);
        }
        ...
        public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                this.objValidador.validarStringConOpciones(this.enumFiltro,
                                EnumParametro.TIMEFRAME_LIQUIDITY_GRAB_CANDLE,
                                valoresSeleccionados.get(EnumParametro.TIMEFRAME_LIQUIDITY_GRAB_CANDLE),
                                TIMEFRAMES_SOPORTADOS)
                                .ifPresent(errores::add);

                this.objValidador.validarInteger(this.enumFiltro, EnumParametro.LOOKBACK_VELAS_LIQUIDITY_GRAB_CANDLE,
                                valoresSeleccionados.get(EnumParametro.LOOKBACK_VELAS_LIQUIDITY_GRAB_CANDLE), 3, 50)
                                .ifPresent(errores::add);

                this.objValidador.validarFloat(this.enumFiltro, EnumParametro.PROPORCION_MECHA_CUERPO_LIQUIDITY_GRAB_CANDLE,
                                valoresSeleccionados.get(EnumParametro.PROPORCION_MECHA_CUERPO_LIQUIDITY_GRAB_CANDLE),
                                1.0F, 10.0F)
                                .ifPresent(errores::add);

                this.objValidador.validarString(this.enumFiltro, EnumParametro.DIRECCION_LIQUIDITY_GRAB_CANDLE,
                                valoresSeleccionados.get(EnumParametro.DIRECCION_LIQUIDITY_GRAB_CANDLE),
