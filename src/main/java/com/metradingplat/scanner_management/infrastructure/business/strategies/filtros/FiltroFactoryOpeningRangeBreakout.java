...
public class FiltroFactoryOpeningRangeBreakout implements IFiltroFactory {
    ...
    public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        // con velas de hoy, sin importar si de verdad rompio por encima del
    ...
    private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
        ...
        // de apertura) -- IGUAL_A 1 es la unica condicion que tiene sentido.
        ...
        return new Parametro(EnumParametro.CONDICION, "parameter.openingRangeBreakout.condicion", valor, opciones);
    }
