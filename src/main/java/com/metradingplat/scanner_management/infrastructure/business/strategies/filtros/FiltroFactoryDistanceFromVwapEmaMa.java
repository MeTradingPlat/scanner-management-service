...
public class FiltroFactoryDistanceFromVwapEmaMa implements IFiltroFactory {
        ...
        private Parametro crearParametroLineaReferencia(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.LINEA_REFERENCIA_DISTANCE_FROM_VWAP_EMA_MA,
                                EnumParametro.LINEA_REFERENCIA_DISTANCE_FROM_VWAP_EMA_MA.getEtiqueta(), valor,
                                opciones);
        }
        ...
        private Parametro crearParametroModoDistancia(ValorString valorUsuario) {
                ...
                ValorString valor = new ValorString(
                                ...
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.MODO_DISTANCIA_DISTANCE_FROM_VWAP_EMA_MA,
        ...
        public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                this.objValidador.validarString(this.enumFiltro,
                                EnumParametro.LINEA_REFERENCIA_DISTANCE_FROM_VWAP_EMA_MA,
                ...
                Valor lineaReferenciaValor = valoresSeleccionados
                                .get(EnumParametro.LINEA_REFERENCIA_DISTANCE_FROM_VWAP_EMA_MA);
                if (lineaReferenciaValor instanceof ValorString &&
                                (((ValorString) lineaReferenciaValor).getValor()
                                                ...
                                                ((ValorString) lineaReferenciaValor).getValor()
                                                                .equalsIgnoreCase(EnumLineaReferencia.MA.name()))) {
                        this.objValidador.validarInteger(this.enumFiltro,
                                        EnumParametro.PERIODO_LINEA_DISTANCE_FROM_VWAP_EMA_MA,
                                        valoresSeleccionados.get(EnumParametro.PERIODO_LINEA_DISTANCE_FROM_VWAP_EMA_MA),
                                        2, 200)
                                        .ifPresent(errores::add);
                }
