...
public class FiltroFactoryConsecutiveCandles implements IFiltroFactory {
        ...
        private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
                ...
                valor.setValoresPermitidos(CondicionalOpciones.alcistaBajistaNinguna());
                return new Parametro(EnumParametro.CONDICION, "parameter.consecutiveCandles.condicion", valor, opciones);
        }
