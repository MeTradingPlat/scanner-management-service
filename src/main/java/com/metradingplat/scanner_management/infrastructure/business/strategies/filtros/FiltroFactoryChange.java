...
import com.metradingplat.scanner_management.domain.enums.valores.EnumPuntoReferencia;
...
public class FiltroFactoryChange implements IFiltroFactory {
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                parametros.add(this.crearParametroPuntoReferencia(
                                (ValorString) valoresSeleccionados.get(EnumParametro.PUNTO_REFERENCIA_CHANGE)));
                parametros.add(this
                                .crearParametroTipoMedida((ValorString) valoresSeleccionados
                                                .get(EnumParametro.TIPO_MEDIDA_CHANGE)));
        ...
        private Parametro crearParametroPuntoReferencia(ValorString valorUsuario) {
                ...
                EnumPuntoReferencia enumValor = valorUsuario != null
                                ? EnumPuntoReferencia.valueOf(valorUsuario.getValor())
                                : EnumPuntoReferencia.CLOSE;
                ValorString valor = new ValorString(
                                enumValor.getEtiqueta(),
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.PUNTO_REFERENCIA_CHANGE,
                                EnumParametro.PUNTO_REFERENCIA_CHANGE.getEtiqueta(),
                                valor, opciones);
        }
        ...
        private Parametro crearParametroTipoMedida(ValorString valorUsuario) {
                ...
                EnumTipoValorMedida enumValor = valorUsuario != null
                                ...
                                : EnumTipoValorMedida.PRECIO;
                ValorString valor = new ValorString(
                                enumValor.getEtiqueta(),
                                enumTipoValor,
                                enumValor.name());
                return new Parametro(EnumParametro.TIPO_MEDIDA_CHANGE, EnumParametro.TIPO_MEDIDA_CHANGE.getEtiqueta(),
                                valor,
                                opciones);
        }
        ...
        public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                this.objValidador
                                .validarCondicional(this.enumFiltro, EnumParametro.CONDICION,
                                                valoresSeleccionados.get(EnumParametro.CONDICION), -1000.0F, 1000.0F)
                                .ifPresent(errores::add);

                this.objValidador.validarString(this.enumFiltro, EnumParametro.PUNTO_REFERENCIA_CHANGE,
                                valoresSeleccionados.get(EnumParametro.PUNTO_REFERENCIA_CHANGE),
                                EnumPuntoReferencia.class)
                                .ifPresent(errores::add);
