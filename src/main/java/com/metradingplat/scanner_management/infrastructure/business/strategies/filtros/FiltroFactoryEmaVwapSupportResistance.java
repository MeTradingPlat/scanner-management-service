...
public class FiltroFactoryEmaVwapSupportResistance implements IFiltroFactory {
        ...
        public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
                ...
                // simbolo con >= 3 velas, sin importar si de verdad hubo un
                // rebote confirmado (compute_value devuelve 0.0 si no, o el %
                // con signo si si -- FUERA de una banda casi-cero captura
                // "si hubo rebote".
