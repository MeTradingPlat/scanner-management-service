...
public class FiltroFactoryRelativeVolumeSameTime implements IFiltroFactory {
    ...
    public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        // Sin esto no habia forma de que el usuario eligiera el timeframe --
        // extraer_timeframe_minutos() en signal-processing-service caia
    ...
    private Parametro crearParametroTimeframe(ValorString valorUsuario) {
        ...
        ValorString valor = new ValorString(
                ...
                enumTipoValor,
                enumValor.name());
        return new Parametro(EnumParametro.TIMEFRAME_RELATIVE_VOLUME_PERCENT,
    ...
    public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        this.objValidador
                .validarCondicional(this.enumFiltro, EnumParametro.CONDICION,
                        valoresSeleccionados.get(EnumParametro.CONDICION), 20.0F, 2_000.0F)
